...
class CIOOrchestrator:
    ...
    v2: Direct Trust — the base model IS the risk manager.
    """
    ...
    def run(
        ...
        for day_i, date in enumerate(dates):
            ...
            # Direct trust: allocation weights pass through, no position gate
            target_weights = {}
            ...
            # Feed returns to allocators that track history
